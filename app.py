...
# ── Register pages using ROOT-level paths (no pages/ subfolder) ──────────────
...
.sidebar-logo-text h2 {
    ...
    font-weight: 800 !important; color: #E8EAF0 !important; letter-spacing: 1px;
}
.sidebar-logo-text p {
    margin: 0 !important; font-size: 0.62rem !important;
    color: #E8452C !important; letter-spacing: 2.5px; font-weight: 600 !important;
}
...
[data-testid="stSidebar"] a[data-testid="stPageLink-NavLink"] {
    display: block !important; padding: 0.5rem 0.8rem !important;
    border-radius: 8px !important; font-size: 0.9rem !important;
    font-weight: 600 !important; color: #9AA3B2 !important;
...
[data-testid="stSidebar"] a[data-testid="stPageLink-NavLink"]:hover {
    background: #0F1520 !important; border-color: #1C2333 !important;
    color: #E8EAF0 !important;
}

.home-btn > button {
    background: linear-gradient(135deg, #E8452C18, #E8452C08) !important;
    color: #E8EAF0 !important; border: 1px solid #E8452C55 !important;
    border-radius: 8px !important; font-family: 'Syne', sans-serif !important;
    font-weight: 700 !important; font-size: 0.9rem !important;
    width: 100% !important; text-align: left !important;
    padding: 0.55rem 0.8rem !important; margin-bottom: 0.25rem !important;
...
[data-testid="stMetric"] {
    background: #0F1520; border: 1px solid #1C2333;
    border-radius: 12px; padding: 1.2rem 1.4rem;
}
[data-testid="stMetricValue"] {
    font-family: 'DM Mono', monospace !important;
    font-size: 1.6rem !important; color: #E8EAF0 !important;
}
[data-testid="stMetricDelta"] { font-size: 0.8rem !important; }
[data-testid="stDataFrame"] { border-radius: 10px; overflow: hidden; }

.stButton > button {
    background: #E8452C !important; color: white !important;
...
# ── Home screen (shown when app.py is the active page) ───────────────────────
