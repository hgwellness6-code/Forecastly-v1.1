...
with col1:
    if st.button("📤 Upload Data", use_container_width=True, key="ov_upload"):
        st.switch_page("pages/2_Upload.py")
with col2:
    if st.button("📊 Dashboard", use_container_width=True, key="ov_dashboard"):
        st.switch_page("pages/3_Dashboard.py")
with col3:
    if st.button("📈 Forecast", use_container_width=True, key="ov_forecast"):
